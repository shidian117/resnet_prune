...
parser.add_argument(
    "--model_dir1", default="./client_model_infer_qat_opt8.nb", type=str, help="Non-combined Model dir path")
parser.add_argument(
    "--model_dir2", default="./server_model_infer_qat_opt8.nb", type=str, help="Non-combined Model dir path")
