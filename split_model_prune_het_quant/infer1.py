...
def run2(args,image):
    ...
    # 设置输入
    #fake_input = np.random.randn(args.batch_size, 3, 318, 318).astype("float32")
    input_handle.reshape([args.batch_size, 128, 3, 3])
    input_handle.copy_from_cpu(image)
...
def parse_args():
    ...
    parser.add_argument("--model_file1", default="./client_model_infer_qat.pdmodel", type=str, help="model filename")
    parser.add_argument("--params_file1", default="./client_model_infer_qat.pdiparams" ,type=str, help="parameter filename")
    parser.add_argument("--model_file2", default="./server_model_infer_qat.pdmodel", type=str, help="model filename")
    parser.add_argument("--params_file2", default="./server_model_infer_qat.pdiparams" ,type=str, help="parameter filename")
