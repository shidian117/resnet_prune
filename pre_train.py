...
add_arg('lr',                       float,  0.2,                                      "The learning rate used to fine-tune pruned model.")
...
parser.add_argument('--step_epochs', nargs='+', type=int, default=[80, 120, 160], help="piecewise decay step")
# yapf: enable
...
def get_pruned_params(args, model):
    ...
    if args.model == "mobilenet_v1":
        ...
        raise NotImplementedError(
            "Current demo only support for mobilenet_v1, mobilenet_v2, resnet50")
    return params
...
def compress(args):
    ...
    if args.model == "mobilenet_v1":
        ...
        net = resnet50(num_classes=class_dim)
    else:
